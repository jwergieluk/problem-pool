...
Zeigen Sie, dass
\begin{equation*}
    \bfE \max\left\{ X,Y \right\} = \sqrt{\frac{1-\rho}{\pi}}
\end{equation*}
gilt.
% source: Shao, keywords: {bivariate normal, multivariate normal}

\paragraph{Korrelation und Symmetrie.} Seien $X$ eine stetige Zufallsgröße mit 
endlicher Varianz und $Y = |X|$. Beweisen Sie: Ist $X$ symmetrisch, so sind
...
\paragraph{Bedingte Dichet. Ein Rechenbeispiel.} Sei $(X,Y)$ ein 
