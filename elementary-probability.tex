...
\paragraph{Bedingte Wahrscheinlichkeit. Urne mit Loch.} In einer Urne befinden
...
\begin{enumerate}
    ...
    \item Nun ist $d \leq s+w$. Wie groß ist die Wahrscheinlichkeit, dass die
        gezogene Kugel weiß ist?
\end{enumerate}
...
sind zwei Urnen mit Kugeln gegeben. Eine der Urnen enthält $2$ weiße und $8$
schwarze Kugeln und die andere enthält $3$ weiße und $7$ schwarze Kugeln. Es
ist unbekannt, welche Urne ist welche.  Es sollen $2$ gezogen werden. Geben Sie
einen Ziehprozedur an, die die Wahrscheinlichkeit, dass zwei weiße Kugeln
gezogen werden unter allen Ziehprozeduren maximiert. 



\paragraph{Bedingte Wahrscheinlichkeiten. Simpsons Paradoxon.} 
...
\begin{enumerate}
    ...
    \item Der gewählte Autofahrer hat im letzten Jahr ein Unfall gehabt. Wie
        groß ist die Wahrscheinlichkeit, dass der Autofahrer männlich ist?
\end{enumerate}



\paragraph{Bedingte Wahrscheinlichkeiten. Urnenmodell von Polya. II.} Eine Urne
enthält $s$ schwarze und $w$ weiße Kugeln. Es wird eine Kugel zufällig gezogen,
ihre Farbe notiert und die Kugel gemeinsam mit $d$ weiteren Kugeln von der
gleichen Farbe in die Urne gelegt. Die Prozedur wird anschließend wiederholt.
\begin{enumerate}
    \item Bezeichne mit $B_n$ das Ereignis, dass bei der $n$-ten Ziehung
        schwarze Kugel gezogen wird. Zeigen Sie, dass $P(B_1)=P(B_n)$ für alle
        $n\in\bN$ gilt.
    \item Berechnen Sie die Wahrscheinlichkeit, dass in einer Sequenz von $n$
        Ziehungen $k$ schwarze Kugeln gezogen.
\end{enumerate}
