...
\begin{enumerate}
    \item Die Entfernung sei $D=100\,$m. Berechnen Sie die Wahrscheinlichkeit dafür,
        dass mehr als $35$ Bits von der obigen Nachricht falsch übertragen
        werden. 
    ...
    \item Zur Verminderung der Fehlerrate wird jedes Bit der Nachricht $3$ mal
        ...
        $D=100\,m$ die Wahrscheinlichkeit dafür, dass mehr als $35$ Bits von
        der ursprünglichen $512$ Bits langen Nachricht falsch übertragen werden.
...
\paragraph*{Lösung.} Wir wollen auf Brauchbarkeit des Geräts schließen, daher 
testen wir
\begin{align*}
