...
Sei $\Omega$ ein endlicher Grundraum. Zeigen Sie, dass die Menge aller Teilmengen von
$\Omega$, also die Potenzmenge $2^{\Omega}$, endlich und eine $\sigma$-Algebra ist.

\problem{$\sigma$-Algebren. Restriktion.}
Sei $\cA$ eine $\sigma$-Algebra von Teilmengen eines Grundraumes $\Omega$ und
$B \in \cA$. Zeigen Sie, dass $\cC = \left\{ A\cap B : A\in\cA \right\}$ eine
$\sigma$-Algebra von Teilmengen von $B$ ist.
...
\solution $P(B) = P(A \cup (B \setminus A))= P(A) + P(B\setminus A) \geq P(A)$. 
...
\problem{Kombinatorik. PINs und runs.} In einer Folge $\left( a_1, a_2, a_3,
...
\problem{Bedingte Wahrscheinlichkeiten. Urnenmodell von Polya.} Eine Urne
