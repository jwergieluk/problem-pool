...
\paragraph{Bedingte Wahrscheinlichkeiten. 3 Würfel.} Wir werfen drei faire Würfel. 
\begin{enumerate}
    \item Was ist die Wahrscheinlichkeit, dass kein Sechser geworfen wird? 
    \item Was ist die Wahrscheinlichkeit, dass kein Sechser geworfen wird, wenn
        wir wissen, dass verschiedene Zahlen geworfen wurden. 
\end{enumerate}
...
\paragraph{Bedingte Wahrscheinlichkeiten. 2 Münzen.} Wir werfen zwei faire Münzen.
\begin{enumerate}
...
\begin{enumerate}
    ...
    \item \textbf{Zusatz:} Zeigen Sie, dass $\fA_B$ eine $\sigma$-Algebra ist.
\end{enumerate}
...
der Urne gezogen, beiseite gelegt und anschliessend eine weitere Kugel gezogen.
Berechnen Sie die Wahrscheinlichkeiten der folgenden Ereignisse:
\begin{enumerate}
    \item Beide Kugel sind weiß.
    \item Die erste Kugel weiß und die zweite Kugel schwarz ist.
\end{enumerate}
