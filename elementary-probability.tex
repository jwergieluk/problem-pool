...
\end{equation*}
exponentialverteilt ist und es gilt $X_{(1)} \sim \mathbf{Ex}(\lambda_1+\dots+\lambda_n)$.
...
Zeigen Sie folgende Aussagen: 
\begin{enumerate}
    \item Das $n$-te Moment $\bfE X^{n}$, für $n\in\bN$, ist gegeben durch
        \begin{equation*}
            \bfE X^n = \frac{1}{n+1}\left( b^{n}a^0 + \cdots + b^{0}a^{n} \right).
        \end{equation*}
...
Sei $X$ Cauchyverteilt mit der Dichtefunktion
\begin{equation*}
    p(x) = \frac{1}{\pi (1+x^2)}.
\end{equation*}
Zeigen Sie folgende Aussagen:
\begin{enumerate}
    \item Die Funktion $p$ ist wirklich eine Dichtefunktion.
    \item Der Erwartungswert $\bfE X$ existiert nicht.
    \item Die Momente $\bfE X^n$ existieren für alle positiven $n\in \bN$ nicht.
\end{enumerate}
