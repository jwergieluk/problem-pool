...
ist in diesem Fall nicht identifizierbar. 
...
Seien $X_1,\ldots,X_n$ i.i.d.\ mit jeweils folgender Dichte. Finden Sie in allen
drei Fällen eine reellwertige suffiziente Statistik für $\theta$: 
\begin{enumerate}
...
\end{equation*}
sowie $\theta = (\mu, \sigma)^\top$ und $\Theta = \R \times \R_{>0}$. Zeigen Sie, dass 
\begin{enumerate}
    \item $\min(X_1,\ldots,X_n)$ eine suffiziente Statistik für $\mu$ ist,
        falls $\sigma$ bekannt ist.
